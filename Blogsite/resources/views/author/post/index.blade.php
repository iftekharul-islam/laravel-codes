...
<div class="container-fluid">
            <div class="block-header">
            	...
            	<a class="btn btn-primary wave-effect" href="{{ route('author.post.create')}}">
                                        ...
                                        @foreach($posts as $key=>$post)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('author.post.show',$post->id) }}" class="btn btn-info wave-effect">
                                                        <i class="material-icons">visibility </i>
                                                    </a>
                                                    <a href="{{ route('author.post.edit',$post->id) }}" class="btn btn-info wave-effect">
