...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/css/single-post/styles.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/css/single-post/responsive.css') }}">
